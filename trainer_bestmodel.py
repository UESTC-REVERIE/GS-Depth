...
class Trainer:
    def __init__(self, options):
        ...
        val_dataset = self.dataset(
            ...
            self.opt.frame_ids, 1, is_val=True, img_ext=img_ext)
        ...
        for scale in self.opt.scales:
            ...
            self.backproject_depth[scale] = BackprojectDepth_removedxy_v1(self.opt.batch_size, h, w)
            self.backproject_depth[scale].to(self.device)

            self.project_3d[scale] = Project3D_removedxy_v1(self.opt.batch_size, h, w)
    ...
    def process_batch(self, mode, inputs):
        ...
        if self.opt.pose_model_type == "shared":
            ...
            if mode == 'val':
                ...
                outputs["output", 0] = self.models["depth"](features,)
            else:
