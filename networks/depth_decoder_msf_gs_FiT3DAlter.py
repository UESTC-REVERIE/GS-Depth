...
class DepthDecoder_MSF_GS_FiTAlter(nn.Module):
    def __init__(self, num_ch_enc, scales=range(4), num_output_channels=1, use_skips=True, 
                 use_gs=False, gs_scale=0, min_depth=0.1, max_depth=100.0, height=192, width=640):
        super(DepthDecoder_MSF_GS_FiTAlter, self).__init__()
        ...
        if self.use_gs:
            ...
            if self.gs_scale == 0:
                ...
                self.convs[("gs_feature_conv"), 2, 32] = ConvBlock(64, self.num_ch_enc[4])
                # 6. Rasterizer
                self.feature_rasterizer_32 = Rasterize_Gaussian_Feature_FiT3D_v1(image_height=self.height//self.gs_scale, 
                ...
                self.convs[("gs_feature_conv"), 2, 16] = ConvBlock(64, self.num_ch_enc[3])
                # 6. Rasterizer
                self.feature_rasterizer_16 = Rasterize_Gaussian_Feature_FiT3D_v1(image_height=self.height//self.gs_scale, 
                                                                    image_width=self.width//self.gs_scale)
                ...
                self.convs[("gs_feature_conv"), 2, 8] = ConvBlock(64, self.num_ch_enc[2])
                # 6. Rasterizer
                self.feature_rasterizer_8 = Rasterize_Gaussian_Feature_FiT3D_v1(image_height=self.height//self.gs_scale, 
                                                                    image_width=self.width//self.gs_scale)
                ...
                self.convs[("gs_feature_conv"), 2, 4] = ConvBlock(64, self.num_ch_enc[1])
                # 6. Rasterizer
                self.feature_rasterizer_4 = Rasterize_Gaussian_Feature_FiT3D_v1(image_height=self.height//self.gs_scale, 
                                                                    image_width=self.width//self.gs_scale)
    ...
    def forward(self, input_features, inv_K, K):
        ...
        if self.use_gs:
            if self.gs_scale == 0:
                ...
                d0_4 = self.convs[("gs_feature_conv"), 2, 32](gs_feature)
                ...
                self.outputs[("gs_feature_before", 2)] = e0_feature
                ...
                self.outputs[("gs_feature_after", 2)] = gs_feature
